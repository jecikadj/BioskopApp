...
VALUES ('12345', 'Jelena','Djordjevoc','asd@gmail.com','gledalac','jecika',true,'12.5.2005','1234556');
INSERT INTO GLEDALAC (password,name,surname,email,role,user_name,active,Date,contact_tel) 
VALUES ('ninja', 'Jovana','Cankovic','cankj@gmail.com','gledalac','dzoca',true,'21.12.2012','1234556');

INSERT INTO GLEDALAC (password,name,surname,email,role,user_name,active,Date,contact_tel) 
VALUES ('1231', 'Jelena','Djordjevic','jecika@gmail.com','gledalac','jeca',true,'21.12.2022','060001123');


INSERT INTO MENADZER (user_name,password,name,surname,Role,active,Date,email,contact_tel) 
VALUES ('jecika','jec','jelena','djo','Menadzer',true,'12.02.2002.','ggg@gmail.com','555123');
INSERT INTO MENADZER (user_name,password,name,surname,Role,active,Date,email,contact_tel) 
VALUES ('dzeca','1234','milana','radov','Menadzer',true,'12.02.2006.','wp@gmail.com','333555');

INSERT INTO ADMINISTRATOR (user_name,password,name,surname,Role,active,Date,email,contact_tel) 
VALUES ('glogi','1223','dusan','glogovac','Administrator',true,'12.02.2004.','glogi@gmail.com','666333');

INSERT INTO BIOSKOP (naziv,adresa,br_centrale,email,manager_id) 
VALUES ('Cineplexx', 'Omladinska','12345','asd@gmail.com',1);
INSERT INTO BIOSKOP (naziv,adresa,br_centrale,email,manager_id) 
VALUES ('Arena', 'Dunavska','54321','ff@gmail.com',2);
INSERT INTO BIOSKOP (naziv,adresa,br_centrale,email,manager_id) 
VALUES ('Prom', 'Centarska','4455','surr@gmail.com',2);
INSERT INTO BIOSKOP (naziv,adresa,br_centrale,email,manager_id) 
VALUES ('Cineplexx', 'Dunavska','54321','ff@gmail.com',2);
INSERT INTO BIOSKOP (naziv,adresa,br_centrale,email,manager_id) 
VALUES ('Arena', 'Centarska','4455','surr@gmail.com',1);
